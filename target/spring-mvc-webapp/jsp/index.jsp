            ...
            <div class="navbar">
                <ul class="nav nav-tabs">
                    ...
                    <c:if test="${pageContext.request.userPrincipal.name != null}">
                        ...
                        <c:if test="${pageContext.request.userPrincipal.name != null}">
                        <h4 id="user" class="col-md-2 pull-right">User:&nbsp;&nbsp;&nbsp;${pageContext.request.userPrincipal.name}</h4>
                    </c:if>
                </ul>
                ...
                <div class="row">
                    <div class="row">
                        ...
                        <div id="employeeOfWeek" class="col-md-5">
                            ...
                            <div class="row">
                                <p style="padding-left: 20px;padding-right: 20px;" id="eotwBody" class="text-center">${description}</p>
                            </div>
                        </div>
                    </div>
